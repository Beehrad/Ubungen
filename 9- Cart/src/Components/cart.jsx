...
const Cart = () => {
  const { cart, dispatch , total } = UseCartContext();

  let renderedContent = (
    <>
      <RiShoppingCartLine style={{ fontSize: "8rem" }} />
      <h5 className="text-center"> هیچ آیتمی در سبد خرید موجود نمیباشد</h5>
    </>
  );
      ...
      <>
        ...
        <div className="col-lg-4 col-md-5 pt-3 pt-sm-4 border-end">
          <div className="text-center mb-4 pb-3 border-bottom">
            ...
            <h4 className="fw-normal">{total} تومان</h4>
          </div>
          <a onClick={()=> dispatch({type : "CLEAR_CART"})} className="btn btn-primary btn-shadow d-block w-100 mt-4">
            حذف همه آیتم ها
          </a>
        </div>
      </>
